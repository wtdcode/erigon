...
func ExecV3(ctx context.Context,
	...
	if initialCycle {
		...
		if err := agg.BuildOptionalMissedIndices(ctx, estimate.IndexSnapshot.WorkersHalf()); err != nil {
			return err
		}
		if err := agg.BuildMissedIndices(ctx, estimate.IndexSnapshot.WorkersHalf()); err != nil {
			return err
		}
	} else {
